...
int main() {
    ...
    mimg_rnd_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 5, 64);
    ...
    mimg_rnd_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 5, 32);

    stbi_write_jpg("./test/rnd_mask_quantize_5_32.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_rnd_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 5, 128);
