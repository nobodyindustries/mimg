...
int main() {
    ...
    mimg_and(img1.width, img1.height, img1.pixels, img2.pixels, new_pixels);

    stbi_write_jpg("./test/and_test.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_and(img1.width, img1.height, img1.pixels, mask.pixels, new_pixels);

    stbi_write_jpg("./test/and_test_mask.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);
