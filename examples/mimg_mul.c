...
int main() {
    ...
    stbi_write_jpg("./test/mul_test_2.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_mul(img1.width, img1.height, img1.pixels, 3, new_pixels);

    stbi_write_jpg("./test/mul_test_3.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);
