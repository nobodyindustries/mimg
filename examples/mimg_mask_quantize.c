...
int main() {
    ...
    mimg_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 3);
    ...
    mimg_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 4);

    stbi_write_jpg("./test/mask_quantize_4.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 5);

    stbi_write_jpg("./test/mask_quantize_5.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 6);

    stbi_write_jpg("./test/mask_quantize_6.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_mask_quantize(img1.width, img1.height, img1.pixels, new_pixels, 7);
