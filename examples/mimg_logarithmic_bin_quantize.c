...
int main() {
    ...
    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 4);
    ...
    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 8);

    stbi_write_jpg("./test/mimg_logarithmic_bin_quantize_8.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 16);

    stbi_write_jpg("./test/mimg_logarithmic_bin_quantize_16.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 32);

    stbi_write_jpg("./test/mimg_logarithmic_bin_quantize_32.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 128);

    stbi_write_jpg("./test/mimg_logarithmic_bin_quantize_128.jpg", img1.width, img1.height,
                   MIMG_EXPECTED_N_CHANNELS, new_pixels, MIMG_OUTPUT_JPG_QUALITY);

    mimg_logarithmic_bin_quantize(img1.width, img1.height, img1.pixels, new_pixels, 255);
